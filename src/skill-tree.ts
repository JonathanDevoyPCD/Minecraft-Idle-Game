...
const worldGrowth: SkillNodeDefinition[] = [
  ...
  node('world-growth-biomes', 'world-second-mine-site', 'Second Mine Site', 'Open a second rail entrance so mining can continue in parallel.', 'Unlocks one additional mine site.', 'unlock', ['world-cave-entrance']),
  node('world-growth-biomes', 'world-third-mine-site', 'Third Mine Site', 'Establish a third rail entrance for a stronger mining network.', 'Unlocks one additional mine site.', 'unlock', ['world-second-mine-site']),
